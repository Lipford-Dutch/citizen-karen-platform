      ...
      <div className="track-layout">
        {caseStatus ? (
          <article className="case-card" aria-labelledby="case-title">
            <header>
              <div>
                <h2 id="case-title">FCC complaint</h2>
                <p className={`case-state state-${caseStatus.state}`}>
                  <Check aria-hidden="true" />
                  {caseStatus.state === "deleted" ? "Local copy deleted" : "Submitted to agency"}
                </p>
              </div>
            ...
            <ol className="case-timeline" aria-label="Complaint status timeline">
              ...
              <li className={caseStatus.state !== "deleted" ? "is-complete" : ""}><span><Check aria-hidden="true" /></span><strong>Submitted to FCC</strong><small>{formatDate(caseStatus.last_updated)}</small></li>
            ...
            <div className="case-actions">
              ...
              <a href="https://consumercomplaints.fcc.gov/hc/en-us" target="_blank" rel="noreferrer"><ExternalLink aria-hidden="true" /> Open FCC website</a>
        ...
        <aside className="next-steps" aria-labelledby="next-steps-heading">
          ...
          <p>Your complaint is with the FCC after successful submission.</p>
          <p>Once submitted, the agency handles review and response. Agency timing is outside Citizen Karen’s control and may vary.</p>
      ...
      {showDelete ? (
        <div className="modal-backdrop" role="presentation" onMouseDown={closeDeleteDialog}>
          <section ref={deleteDialogRef} className="confirm-dialog" role="alertdialog" aria-modal="true" aria-labelledby="delete-heading" onMouseDown={(event) => event.stopPropagation()}>
            ...
            <p>This deletes the complaint content stored by Citizen Karen. It cannot delete the FCC’s separate copy.</p>
            <div>
